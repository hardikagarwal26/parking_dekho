...
//
//        gpay = (ImageView) v.findViewById(R.id.gpayButtonID);
...
//                    }
//                }
//                Toast t = Toast.makeText(getActivity(), "Thank you for paying with Card", Toast.LENGTH_LONG);
...
//                    }
//                }
//                Toast t = Toast.makeText(getActivity(), "Thank you for paying with Cash", Toast.LENGTH_LONG);
//                t.setGravity(Gravity.CENTER, 0, 0);
//                t.show();
//            }
//        });
...
public class ReserveListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        bkash = (ImageView) v.findViewById(R.id.gpayButtonID);
        dbbl = (ImageView) v.findViewById(R.id.dbblButtonID);
